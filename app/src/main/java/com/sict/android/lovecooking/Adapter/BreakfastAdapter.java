...
public class BreakfastAdapter extends RecyclerView.Adapter<ListDishViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ListDishViewHolder holder, int position) {
        ...
        String[] dishInfo = breakfastList.get(position).split("#");
        ...
        if(deleteOrNot){
            ...
            holder.remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    notifyItemRangeChanged(position,breakfastList.size());
                    editor.putString("breakfast",
                            removeDishId(sharedPreferences.getString("breakfast","null"), dishInfo[0])
                    );
                    editor.apply();
