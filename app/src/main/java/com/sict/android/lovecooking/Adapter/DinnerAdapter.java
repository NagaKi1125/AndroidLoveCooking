...
public class DinnerAdapter extends RecyclerView.Adapter<ListDishViewHolder> {
    ...
    public void setData(List<String> dinnerList, Context context, String menu_id, Boolean deleteOrNot) {
    ...
    public void onBindViewHolder(@NonNull ListDishViewHolder holder, int position) {
        ...
        String[] dishInfo = dinnerList.get(position).split("#");
        ...
        if(deleteOrNot){
            ...
            holder.remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    notifyItemRangeChanged(position,dinnerList.size());
                    editor.putString("dinner",
                            removeDishId(sharedPreferences.getString("dinner","null"), dishInfo[0])
                    );
                    editor.apply();
